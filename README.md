...
dashboard_images/
├── eda/
│   ├── chart01_most_wins.png
│   ├── chart02_win_percentage.png
│   ├── chart07_top_run_scorers.png
│   ├── chart11_dhoni_death_overs.png
│   └── ... (31 charts total)
└── powerbi/
    ├── page1_executive_summary.png
    ├── page2_team_analysis.png
    ├── page3_player_analysis.png
    ├── page4_venue_analysis.png
    ├── page5_season_analysis.png
    └── page6_best_xi.png
```
